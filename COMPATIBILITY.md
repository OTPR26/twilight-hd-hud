...
Twilight HD and Dawnlight intentionally share several Dusklight HUD hooks.
...
- Twilight HD supplies TPHD artwork, menu presentation, prompts, and control behavior.
...
Do not move Twilight HD's shared Meter Draw, Gauge Screen, or Minimap hooks
...
2. Test both mods enabled with Twilight HD before Dawnlight in the mod list.
3. Repeat with Dawnlight before Twilight HD.
...
5. Confirm Twilight HD menus, button artwork, touch controls, and item behavior
   remain functional.
